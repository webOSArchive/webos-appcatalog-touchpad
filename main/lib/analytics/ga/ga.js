(function() {
    ...
    var N = function(i) {
        ...
        ja = function() {
            var i = window,
                l = w;
            if (i && i.gaGlobal && i.gaGlobal.hid) l = i.gaGlobal.hid;
            else {
                l = Y();
    ...
    Z.n.Mb = function(i, l, g, t, k, p, f, h) {
        ...
        d.Nb = function(a, j, c, n, s) {
            var b = d.gc(a),
                e = d.q;
            if (w == b) V(d.R, new Z.n.Lb(e, a, j, c, n, s));
            else {
                b.Bb = e;
                b.Ba = a;
                b.D = j;
    ...
    Z.Fb = function(i) {
        ...
        k.bc = function() {
            ...
            k.eb = g.ha ? l() : p;
            k.Wa = S(g.a.characterSet ? g.a.characterSet : g.a.charset ? g.a.charset : p)
        };
        k.Ic = function() {
    ...
    Z.aa = function(i, l) {
        ...
        function t() {
            var b = c.b,
                e = b.indexOf("www.google.") * b.indexOf(".google.") * b.indexOf("google.");
        ...
        a._getLinkerUrl = function(b, e) {
            var o = b.split("#"),
                ...
                q = a.Tb();
            if (q) if (e && 1 >= o[x]) m += "#" + q;
            else if (!e || 1 >= o[x]) if (1 >= o[x]) m += (U(b, "?") ? B : "?") + q;
            else m = o[0] + (U(b, "?") ? B : "?") + q + "#" + o[1];
            return m
        };
        a.Fc = function() {
            var b;
        ...
        a.sc = function() {
            var b = c.a[A].hash;
            if (b && 1 == b.indexOf("gaso=")) b = P(b, "gaso=", B);
            else b = (b = c.e.name) && 0 <= b.indexOf("gaso=") ? P(b, "gaso=", B) : P(a.i.k(), L, ";");
            if (b[x] >= 10) {
                a.B = b;
                a.Fc()
            }
            ...
            for (b = 0; b < o[x] && (c.ra == -1 || b < c.ra); b++) {
                ...
                if (d(e.host)) if (!e.gatcOnclick) {
                    ...
                    e.onclick = function(m) {
                        var q = !this.target || this.target == "_self" || this.target == "_top" || this.target == "_parent";
                        q = q && !a.Rb(m);
                        a.Mc(m, this, q);
        ...
        a._setTrans = function() {
            ...
            if (b && b.value) {
                ...
                for (b = 0; b < m[x]; b++) {
                    ...
                    if ("T" == e[0]) a._addTrans(e[1], e[2], e[3], e[4], e[5], e[6], e[7], e[8]);
        ...
        a.Mc = function(b, e, o) {
            ...
            if (a.J()) {
                ...
                j.H("&utmt=event&utme=" + S(m.G()) + a.wa(), a.s, a.c, v, r, q);
                if (o) {
                    var u = this;
        ...
        a.db = function(b, e) {
            ...
            if (o || typeof o == "undefined") if (!e.target || e.target == "_self") c.e[A] = e.href;
